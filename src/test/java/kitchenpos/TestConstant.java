...
import kitchenpos.order.deliveryorder.domain.DeliveryOrderType;
import kitchenpos.order.eatinorder.domain.EatInOrderStatus;
import kitchenpos.order.eatinorder.domain.EatInOrderType;
...
import static kitchenpos.order.deliveryorder.domain.DeliveryOrderType.DELIVERY;
import static kitchenpos.order.eatinorder.domain.EatInOrderStatus.*;
import static kitchenpos.order.eatinorder.domain.EatInOrderType.EAT_IN;
...
public class TestConstant {
    ...
    public static final DeliveryOrderType ORDER_TYPE_배달주문 = DELIVERY;
    public static final EatInOrderType ORDER_TYPE_매장내식사주문 = EAT_IN;
    public static final EatInOrderStatus ORDER_STATUS_주문대기 = WAITING;
    public static final EatInOrderStatus ORDER_STATUS_주문수락 = ACCEPTED;
    public static final DeliveryOrderStatus ORDER_STATUS_배달중 = DELIVERING;
    public static final DeliveryOrderStatus ORDER_STATUS_배달완료 = DELIVERED;
    public static final EatInOrderStatus ORDER_STATUS_제공완료 = SERVED;
    public static final EatInOrderStatus ORDER_STATUS_주문완료 = COMPLETED;
    ...
    public static final EatInOrderType ORDER_TYPE_미선택 = null;
