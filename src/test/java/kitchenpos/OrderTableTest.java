...
public class OrderTableTest {
    ...
    private static final EatInOrderStatus ORDER_STATUS_제공완료 = SERVED;
    private static final EatInOrderStatus ORDER_STATUS_주문완료 = COMPLETED;
    ...
    class OrderTableClearTest {
        ...
        void clearOrderTable() {
            ...
            var orderTableResponse = orderTableService.clear(orderTable.getId());
    ...
    private EatInOrder createAndSaveOrder(EatInOrderStatus orderStatus, EatInOrderTable orderTable) {
    ...
    class changeNumberOfGuestsTest {
        ...
        void changeNumberOfGuests() {
            ...
            var orderTableResponse = orderTableService.changeNumberOfGuests(orderTable.getId(), orderTable);
            assertThat(orderTableResponse.getNumberOfGuests()).isEqualTo(CHANGED_NUMBER_OF_GUESTS);
        }
    }

    private EatInOrderTable createAndOrderTable(String name, int numberOfGuests) {
    ...
    private EatInOrderTable createAndSaveOrderTable() {
        var orderTable = createOrderTable(ORDER_TABLE_DEFAULT_NAME);
        orderTableRepository.save(orderTable);
        return orderTable;
    }

    private EatInOrderTable createAndSaveOrderTable(String orderTableName) {
        var orderTable = createOrderTable(orderTableName);
        orderTableRepository.save(orderTable);
        return orderTable;
    }

    private EatInOrderTable createAndSaveOrderTable(String orderTableName, Boolean isOccupied) {
